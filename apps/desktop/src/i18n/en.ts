...
export const en: Translations = {
  ...
  profiles: {
    ...
    connectGateway: 'Connect another Sandora gateway…',
    actions: 'Actions',
    color: 'Color…',
    colorFor: 'Color',
    setColor: color => `Set color ${color}`,
    autoColor: 'Auto',
    noProfiles: 'No agents yet.',
    selectPrompt: 'Select an agent to view its details.',
    ...
    skillsLabel: 'Skills',
    notSet: 'Not set',
    soulDesc: 'The system prompt and persona instructions baked into this agent.',
    soulOptional: 'optional',
    soulPlaceholder: mode => `The system prompt / persona for this agent.\nLeave blank to keep the ${mode} default.`,
