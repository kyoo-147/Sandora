...
const APP_NAME = process.env.HERMES_DESKTOP_APP_NAME || 'Sandora'
...
// electron-builder derives from the build `appId` (com.sandora.desktop) —
// keep this string in sync with package.json `build.appId`. macOS/Linux don't
// need this, so gate it on Windows. (Fixes: desktop approval/turn notifications
// never firing on Windows.)
if (IS_WINDOWS) {
  app.setAppUserModelId('com.sandora.desktop')
}
